...
class Main extends CI_Controller {
	...
	public function __construct(){ 
		...
		$this->load->model('admin/modelo_arbol', 'modelo_arbol'); $this->load->model('admin/modelo', 'modelo');
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//catalogo de entidades
	  public function listado_entidades(){
  ...
  public function procesando_entidades(){
    $data=$_POST;
    $busqueda = $this->modelo->buscando_entidades($data); 
    echo $busqueda;
  } 


	//edicion del especialista o el perfil del especialista o administrador activo
	function nuevo_entidad(  ){
		...
		$data = array_merge($this->data_sistema,$data);		  
		     switch ($this->session->userdata('id_perfil')) {      
		        ...
		        case 2:  //super y funcionario son los unicos que pueden crear entidades
								$this->load->view('admin/entidades/nuevo_entidad',$data);
		          break;
		        default:  
		          redirect('');
		          break;
	...
	function validar_nuevo_entidad(){
		...
		if ( $this->session->userdata('session') !== TRUE ) {
			...
			if ( $this->form_validation->run() === TRUE ){
					...
					if ( $login_check ){ //if ( $login_check === TRUE ){
						...
						$data 								= $this->security->xss_clean( $data );
						$guardar 									= $this->modelo->agregar_entidad( $data );
						if ( $guardar !== FALSE ){
							echo TRUE;
						} else {
