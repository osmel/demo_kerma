...
//Sueldo Base Promedio Mensual por Años de Experiencia
// 3.3
class sueldo_base_pmae
{
    ...
    public function reporte()
    {
        ...
        for($i=0;$i<count($humancapital);$i++) {
            ...
            $this->question='c5';
            $data = $this->CI->model_human_capital->getUsersDataByHumanCapital($this->question,$humancapital[$i], $this->id_usuario);
            $reporte[$i]['usuarios']['tarifa'] = $this->getPromedioUsuarios($data);
...
<td>vsprom</td>
        ...
        foreach ($data as $item=>$key) {
            ...
            echo '<td>' .$key['usuarios']['tarifa'].'</td>';
