<?php if(! defined('BASEPATH')) exit('No tienes permiso para acceder a este archivo');
  ...
  class model_administrativos extends CI_Model{
    ...
    function __construct(){
      ...
      public function listado_subcategorias(){
            ...
            $this->db->from($this->modulos.' m');  //los modulos 
            $this->db->join($this->relacion_modulo__encabezado_pregunta.' r', ' r.id_modulo = m.id');    
            $this->db->join($this->encabezado_pregunta.' e', ' r.id_encabezado_pregunta = e.id');       //los botones
            ...
            $where = '(
                        ( (m.id ='.$this->subcategoria.')   and (cch.id is not null)  and (p.wildcard IS NULL ))
              )';   
      ...
      public function listado_sub_pregunta($data){
            ...
            //and (e.id ='.$data["id_encabezado"] .')  and (gch.id='.$data["id_seleccion"].')
        ...
        public function guardar_selectores_marcados( $data ){
          ...
          //CREATE UNIQUE INDEX selectores_marcados_unico ON kerma_selectores_marcados(id_principal, id_hijo, num_hijo);

          //ALTER TABLE kerma_selectores_marcados ADD PRIMARY KEY (id_principal, id_hijo, num_hijo);
