		...
		<div class="row-fluid1" id="wrapper1">
			...
			<div class="container header-content">
						...
						<div class="col-md-6 col-lg-6 col-sm-6 col-xs-9">
							...
							<div class="text-right welcome-header" style="color:#104A5A !important"> Bienvenid@: <a href="<?php echo base_url(); ?>actualizar_perfil" style="#104A5A"><?php echo $this->session->userdata( 'nombre_completo' ); ?></a>
						    </div>
					   </div>
