...
<input type="hidden" id="categoria_seleccionada" name="categoria_seleccionada" value="0">
					...
					<div class="m-content">
		              ...
		              <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
						...
						<?php    foreach($categorias as $key=>$cat) { 
							 	//print_r("aaaa".$categorias."aaaa");die; 
							?>
									...
									<div class="m-widget24__item">
										...
										<div class="botones-cat row">
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
												...
												<a type="button" href="<?php echo (trim($cat->url_principal)!='') ? '/kerma/'.$cat->url_principal : '#';  ?>" class="blanco-btn btn"> 
				                                	Editar
					                             </a>												
											...
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
												<button <?php echo (($this->session->userdata('id_perfil')==4) ? 'disabled' : ''); ?> 
												class="<?php echo (($this->session->userdata('id_perfil')==4) ? 'completo-btn_inhabilitado' : 'completo-btn'); ?>" type="button" data-toggle="modal" data-target="#modal_usuarios"  name="button" categoria="<?php echo $cat->id_principal; ?>"  >
															Asignar
													</button>
											</div>
										</div>
...
<?php $this->load->view( 'admin/principal/modal_usuarios' ); ?>
<?php //$this->load->view('admin/usuarios/modal_usuarios'); ?>