													...
													<?php //echo $this->session->userdata('nombre_completo'); ?>
															<?php 
																...
																if (isset($usuario->nombre)) 
																 {	$nomb_nom = $usuario->nombre.' '.$usuario->apellidos;}
																 echo $nomb_nom; 
															?>
										...
										<div class="tab-pane active" id="tab_actualizar_perfil">
											 ...
											 <!--declara formulario -->
												 <?php 
  												 ...
  												 $attr = array('class' => 'form-horizontal m-form m-form--fit m-form--label-align-right', 'id'=>'form_usuarios','name'=>$retorno,'method'=>'POST','autocomplete'=>'off','role'=>'form');
												...
												<div class="m-portlet__body">
													...
													<div class="form-group m-form__group row">
														...
														<div class="col-7">
															...
															?>
															<input value="<?php echo  set_value('apellidos',$nomb_nom); ?>" type="text" class="form-control m-input" name="apellidos" placeholder="Apellido (s)">
														</div>
													</div>
													...
													<div class="form-group m-form__group row">
														...
														<div class="col-7">
															<?php 
																...
																?>
																<input value="<?php echo  set_value('telefono',$nomb_nom); ?>" type="text" class="form-control m-input" name="telefono" placeholder="Número Teléfono">
														</div>
													</div>
													...
													<div class="form-group m-form__group row">
														...
														<div class="col-7">
																...
																?>
																<input value="<?php echo  set_value('pass_1',$nomb_nom); ?>" type="password" class="form-control m-input" name="pass_1" placeholder="Contraseña">
														...
														<div class="col-7">
															<?php 
																...
																if (isset($usuario->contrasena)) 
																 {	$nomb_nom = $usuario->contrasena;}
															?>
															<input value="<?php echo  set_value('pass_2',$nomb_nom); ?>" type="password" class="form-control m-input" name="pass_2" placeholder="Contraseña">															
														</div>
													</div>
													...
													<div class="form-group m-form__group row">
														...
														//$data['entidades_usuarios']

															<?php foreach ( $empresas as $empresa ){ ?>
																
																<?php 
																   if  ( in_array($empresa->id ,  $entidades_usuarios  ) )
																	 {$seleccionado='selected';} else {$seleccionado='';}
																?>
																	<option value="<?php echo $empresa->id; ?>" <?php echo $seleccionado; ?> ><?php echo $empresa->nombre; ?></option>
																<?php //} ?>
															<?php } ?>
