                    ...
                    <div style="text-align:center" class="col-3">
                                  ...
                                  <?php if ( ($value->id_tipo_pregunta==4) || ($value->id_tipo_pregunta==5) ) { // 4-simple, 5-multiples?>
                                   ...
                                   <?php if ($value->id_tipo_pregunta==1) { // input cadena?>
                                            <input type="text" id="<?php echo trim($value->campo); ?>" name="<?php echo $value->campo; ?>" value="" placeholder="<?php echo $value->placeholder; ?>"> 
                                   ...
                                   <?php if ($value->id_tipo_pregunta==7) { //Seleccion id_estado ?>

                                            <select id="<?php echo trim($value->campo); ?>" name="<?php echo $value->campo; ?>" tipo="<?php echo $value->tipo; ?>" class="form-control">
                                                   <?php if ( ($ciudades)  ) { ?>
                                            ...
                                            <span style="color:blue; font-size:10px;"><?php //echo $value->tipo_pregunta; ?></span>
                                            <span style="color:red;font-size:10px;"><?php //echo $value->descripcion_valores_predefinidos; ?></span>
                                   <?php }  ?>
                                   

                                   <?php if ($value->id_tipo_pregunta==8) { //Seleccion id_estado ?>
