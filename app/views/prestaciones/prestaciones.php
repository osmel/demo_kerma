                          ...
                          <div class="m-widget24__item">
                            ...
                            <div class="botones-cat row">
                              <div class="col-12">
                                ...
                                <a href="/kerma/<?php echo $value->url_principal.'/'.$value->url_hijo.'/'.base64_encode($value->id_encabezado).'/'.base64_encode(0).'/'.base64_encode(0); ?>" class="blanco-btn btn"> Editar</a>
                              </div>
                            </div>
                          </div>
                        </div>
