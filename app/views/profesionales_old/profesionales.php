          ...
          <div class="contenido-cat m-widget24">
            <div class="m-widget24__item">
              ...
              <div class="botones-cat row">
                <div class="col-12">
                    <a href="/kerma/profesionales/socios/" class="blanco-btn btn"> Editar</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
          <div class="contenido-cat m-widget24">
            <div class="m-widget24__item">
              ...
              <div class="botones-cat row">
                <div class="col-12">
                    <a href="/kerma/profesionales/abogados_tarifa/" class="blanco-btn btn"> Editar</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
          <div class="contenido-cat m-widget24">
            <div class="m-widget24__item">
              ...
              <div class="botones-cat row">
                <div class="col-12">
                    <a href="/kerma/profesionales/abogados_experiencia/" class="blanco-btn btn"> Editar</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
          <div class="contenido-cat m-widget24">
            <div class="m-widget24__item">
              ...
              <div class="botones-cat row">
                <div class="col-12">
                    <a href="/kerma/profesionales/profesionales_no_abogados/" class="blanco-btn btn"> Editar</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
          <div class="contenido-cat m-widget24">
            <div class="m-widget24__item">
              ...
              <div class="botones-cat row">
                <div class="col-12">
                    <a href="/kerma/profesionales/pasantes/" class="blanco-btn btn"> Editar</a>
                </div>
              </div>
            </div>
          </div>
