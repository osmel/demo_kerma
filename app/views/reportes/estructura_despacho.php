...
$(document).ready(function() {
    ...
    var normal={
        ...
        data: {
            ...
            source: {
                read: {
                    url : '/kerma/reportes/reportes_estructura_despacho/',
        ...
        columns: [
            ...
            },
            {
                ...
                template: function(row) {
                    ...
                    var status = {
                        1: {'titulo': row.ph1, 'clase': 'm-badge--warning'},
                        2: {'titulo': row.ph1, 'clase': 'm-badge--metal'},
            ...
            },
            {
                ...
                template: function(row) {
                    ...
                    var status = {
                        1: {'titulo': row.pm1, 'clase': 'm-badge--warning'},
                        2: {'titulo': row.pm1, 'clase': 'm-badge--metal'},
