    ...
    <div class="m-subheader div-status">
      <div class="d-flex align-items-center">
        <div class="mr-auto"> 
          ...
          <?php 
             $grupos = explode('|', $botones[0]->grupos);
             $grupos_id = explode('|', $botones[0]->grupos_id);
            ...
            <?php if ( ($grupos[0])  ) { ?>
                <?php foreach ($grupos as $key => $value) { ?>
                        ...
                        <div class="item-m2-socios item-m2-socios">
                          <a href="/kerma/<?php echo $sub_pregunta[0]->url_principal.'/'.$sub_pregunta[0]->url_hijo.'/'.base64_encode($sub_pregunta[0]->id_encabezado).'/'.base64_encode($grupos_id[$key]).'/'.base64_encode($key); ?>" valor="<?php echo $grupos_id[$key] ; ?>" type="button" class="btn btn-blockfont-size:10px;"><?php echo $value; ?></a>
                        </div>
